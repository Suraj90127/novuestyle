...
const Products = () => {
  ...
  const handleUpdateSection = (id) => {
    Swal.fire({
      ...
      confirmButtonColor: "#3085d6",
      cancelButtonColor: "#d33",
      confirmButtonText: "Yes, Update Section of this product!",
    }).then((result) => {
      if (result.isConfirmed) {
        dispatch(update_section(id));
        Swal.fire(
          "Updated!",
          "Section of this product has been updated.",
          "success"
        );
      }
    });
              ...
              {products.map((d, i) => (
                <tr key={i}>
                  ...
                  >
                    <div className="flex justify-start items-center gap-4">
                      <button
                        onClick={() => handleUpdateSection(d._id)}
                        className="p-[6px] rounded hover:shadow-lg"
                      >
                        {d.section === 1 ? (

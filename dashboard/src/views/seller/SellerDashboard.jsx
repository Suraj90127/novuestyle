...
const SellerDashboard = () => {
  ...
  // console.log("shipping 11111111111111", shipping);
  ...
  const [cod_fee, setCod_fee] = useState(0);

  const setShippingFee = () => {
    dispatch(set_shipping_fee({ shipping_fee, cod_fee }));
    ...
    <div className="px-2 md:px-7 py-5">
      ...
      <div className="w-full flex flex-wrap mt-7">
        ...
        <div className="w-full lg:w-5/12 lg:pl-4 mt-6 lg:mt-0">
          ...
          <div className="w-full bg-[#283046] space-y-4 p-4 rounded-md text-[#d0d2d6] mt-6">
            <div className="flex justify-between items-center">
              <h2 className="font-semibold text-lg text-[#d0d2d6] pb-3">
                Set Shipping Fee
              </h2>
            ...
            <div className="flex flex-col gap-2">
              <label>Shipping Fee ₹{shipping?.shipping_fee}</label>
              <input
            ...
            <div className="flex flex-col gap-2">
              <label>Cod Fee ₹{shipping?.cod_fee}</label>
              <input
                onChange={(e) => setCod_fee(e.target.value)}
                name="codFee"
                type="number"
            ...
            <button
              onClick={setShippingFee}
              className="bg-[#00d1e8] text-white p-2 rounded-md"
            >
              Set Shipping Fee
            </button>
          </div>

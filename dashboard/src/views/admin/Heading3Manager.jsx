...
import {
  ...
  updateHeading,
  deleteHeading,
} from "../../store/Reducers/heading3Reducer";
import { get_category } from "../../store/Reducers/categoryReducer";

const Heading3Manager = () => {
  const dispatch = useDispatch();
  const { headings, loading, error } = useSelector((state) => state.heading3);
  ...
  const handleSubmit = (e) => {
    ...
    const data = { heading3: headingInput, categorys: categoryInput };
  ...
  const handleEdit = (heading) => {
    ...
    setHeadingInput(heading.heading3);
        ...
        <table className="min-w-full border-collapse text-gray-100">
          ...
          <tbody className="divide-y divide-gray-700">
            {headings.map((h) => (
              ...
              >
                <td className="p-3">{h.heading3}</td>
                <td className="p-3">
                  {h.categorys?.map((sub) => (
                    <div
                      key={sub._id}
...
export default Heading3Manager;

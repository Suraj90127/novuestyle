...
// export const getWinshlist = async (userid) => {
//   console.log("userid", userid);
//   try {
//     const { data } = await api.get(
//       `/home/product/get-wishlist-products/${userid}`
...
export const cardReducer = createSlice({
  ...
  initialState: {
    ...
    shipping_fee: 0,
    outofstock_products: [],
    loading: false, // New state to manage loading
  },
  reducers: {
    messageClear: (state) => {
      state.errorMessage = "";
  ...
  extraReducers: (builder) => {
    ...
    builder
      ...
      // Handle delete_card_product
      .addCase(delete_card_product.pending, (state) => {
        state.loading = true;
      })

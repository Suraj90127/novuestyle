...
class cardController {
  add_to_card = async (req, res) => {
    const { userId, productId, quantity, size, color, unit } = req.body;
  ...
  get_card_products = async (req, res) => {
    ...
    try {
      ...
      console.log("shipping", shipping.shipping_fee);
      responseReturn(res, 200, {
        card_products: p,
        carts: card_products.flatMap((card) => card.products),
